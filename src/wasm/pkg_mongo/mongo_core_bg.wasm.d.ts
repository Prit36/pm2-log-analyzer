...
export const mongoengine_parse_shard: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
...
export const mongoengine_write_slice: (a: number, b: number, c: number) => void;
